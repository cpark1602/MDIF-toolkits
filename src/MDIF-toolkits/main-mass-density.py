...
bin_size = 0.02
pbc=True
if_q0_nac = mass_density.Mass_density(u_if, box, print_results_path, pbc, bin_size, dim, start=start_stop_step[0], stop=start_stop_step[1], step=start_stop_step[2]) 
...
hydrogen_mass = 1; oxygen_mass = 15.999;
Au_mass = 196.96657; Ne_mass = 20.1797
Pt_mass = 195.084
